# -*- coding: utf-8 -*-
"""
Created on Sat Feb 03 10:13:21 2018
...
for d in range(MAX_POLY):
    ...
    plt.plot(x_axis,f(x_axis), color="orange")
...
plt.plot(degrees, squared_bias, label = "squared_bias")
plt.plot(degrees, variance, label = "variance")
plt.plot(degrees, test_scores.mean(axis=0), label="test_scores")
plt.plot(degrees, squared_bias+variance, label="squared_bias+variance")
